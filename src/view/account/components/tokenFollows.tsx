    ...
    <div>
      ...
      {list &&
        ...
        h5:hidden"
            >
              $
              {Number(item?.volume || 0) > 1
                ? Number(
                    NumSplic1(formatScientificNotation(item?.volume), 8)
                  ).toLocaleString()
                : NumSplic1(formatScientificNotation(item?.volume), 8)}
            </div>
            <div
        ...
        h5:hidden"
            >
              $
              {Number(item?.virtualLiquidity || 0) > 1
                ? Number(getBit(item?.virtualLiquidity)).toLocaleString()
                : getBit(item?.virtualLiquidity)}
            </div>
